...
<head>
   ...
   <meta name="description" content="Laravel Bus">
   <meta name="author" content="Alejandro RH">

   <!-- CSRF Token -->
   <meta name="csrf-token" content="{{ csrf_token() }}">

   <title>{{ config('app.name', 'BUS') }}</title>
...
<body id="page-top">
   ...
   <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <!-- Sidebar - Brand -->
         <a class="sidebar-brand d-flex" href="{{ route('jadwal.index') }}">
            <div class="sidebar-brand-icon rotate-n-15">
               <i class="fas fa-shoe-prints"></i>
            </div>
            <div class="sidebar-brand-text mx-3">Sneaker Breed<sup></sup></div>
         </a>

         <!-- Divider -->
         <hr class="sidebar-divider my-0">
         <li class="nav-item {{ Nav::isRoute('shoes.index') }}">
            <a class="nav-link" href="{{ route('shoes.index') }}">
               <i class="fas fa-duotone fa-shoe-prints"></i>
               <span>{{ __('Shoes') }}</span></a>
         </li>
         <li class="nav-item {{ Nav::isRoute('shop.index') }}">
            <a class="nav-link" href="{{ route('shop.index') }}">
               <i class="fas fa-regular fa-shopping-basket"></i>
               <span>{{ __('Shop') }}</span></a>
         </li>
         <li class="nav-item {{ Nav::isRoute('owner.index') }}">
            <a class="nav-link" href="{{ route('owner.index') }}">
               <i class="fas fa-solid fa-address-card"></i>
               <span>{{ __('Owner') }}</span></a>
         </li>
